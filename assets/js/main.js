...
// Prefer inline popup when available; otherwise use accounts page.
if (signInBtn)  signInBtn.onclick  = () => authPopup ? (openAuth(), authEmail?.focus()) : (location.href = "/assets/html/accounts?signin");
if (signUpBtn)  signUpBtn.onclick  = () => authPopup ? (openAuth(), authEmail?.focus()) : (location.href = "/assets/html/accounts?signup");
