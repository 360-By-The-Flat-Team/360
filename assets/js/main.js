...
// Prefer opening inline auth popup when present; fallback to accounts page.
if (signInBtn) {
  signInBtn.onclick = () => {
    if (authPopup) {
      openAuth();
    ...
    location.href = "/assets/html/accounts?signin";
  };
}
if (signUpBtn) {
  signUpBtn.onclick = () => {
    ...
    location.href = "/assets/html/accounts?signup";
  };
}
